// Compliance controller - handles compliance operations (SOLID: Single Responsibility)
...
import { asyncHandler, sendSuccess, sendNotFound } from "../utils/responseHandler.js"

export const addReleases = asyncHandler(async (req, res) => {
    ...
    sendSuccess(res, { release: result.rows[0] }, 201)
})
...
export const registerManifest = asyncHandler(async (req, res) => {
    const { tokenId } = req.params
    ...
    sendSuccess(res, { manifestUri, cid }, 201)
})
